...
PhaserGame.Game.prototype = {
  create: function () {
    ...
    map.addTilesetImage('player', 'turrets');
    ...
    $.enemyWave = ['tanks', 'tanks', 'tanks', 'tanks', 'tanks', 'tanks', 'tanks', 'tanks', 'tanks'];
    ...
    $.turretPosition = ['turrets', 'turrets', 'turrets', 'turrets', 'turrets', 'turrets', 'turrets', 'turrets', 'turrets', 'turrets']
